...
{
    public class ManageContactAPIController : ApiController
    {
        private ContactManagementEntities db = new ContactManagementEntities();

        // GET: api/ManageContactAPI
        public IQueryable<Contact> GetContact()
        {
            return db.Contact;
        }

        // GET: api/ManageContactAPI/5
